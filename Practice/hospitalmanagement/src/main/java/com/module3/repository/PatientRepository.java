...
import com.module3.dto.IPatientInfo;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.module3.dto.CPatientInfo(p.id, p.name) " +
            "from Patient p")
    List<CPatientInfo> getAllPatientsInfoConcrete();

    @Query("select new com.module3.dto.BloodGroupStats(p.bloodGroup, " +
